...
/**
 * dma_heap_buffer_alloc_old - Allocate dma-buf from a dma_heap
 ...
 */
struct dma_buf *dma_heap_buffer_alloc_old(struct dma_heap *heap, size_t len,
				      unsigned int fd_flags,
				      unsigned int heap_flags);

/** dma_heap_buffer_free - Free dma_buf allocated by dma_heap_buffer_alloc_old
