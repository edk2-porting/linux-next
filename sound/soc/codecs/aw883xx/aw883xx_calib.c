...
static ssize_t aw_cali_class_time_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t len)
{
	int ret;
	uint32_t time;
...
static ssize_t aw_cali_class_cali_re_store(const struct class *class, const struct class_attribute *attr, const char *buf, size_t len)
{
	struct list_head *dev_list = NULL;
	struct aw_device *local_dev = NULL;
	int ret = -1;
