...
struct screen_info screen_info_l;
...
static int __init simplefb_earlycon_remap_fb(void)
{
	...
	simplefb_fb = memremap(fb_base, screen_info_l.lfb_size, MEMREMAP_WB);
...
static void simplefb_earlycon_clear_scanline(unsigned int y)
{
	...
	len = screen_info_l.lfb_linelength;
...
static void simplefb_earlycon_scroll_up(void)
{
	...
	len = screen_info_l.lfb_linelength;
	height = screen_info_l.lfb_height;
